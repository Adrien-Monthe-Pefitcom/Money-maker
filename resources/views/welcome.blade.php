...
<head>
    ...
    <title> Obtenez le plus de votre agent. :: Money Maker </title>
    <meta charset="utf-8">
        ...
        <div class="items-center justify-between py-3">
            <div class="row">
                ...
                <div class="col-md-6 text-center" style="align-text: right">
                    <a href="/phone" class="inline-block px-4 py-3 leading-none rounded  bg text-white font-medium no-radius hoverable z-depth-1">
                         Démarrer maintenant                
                    </a>
                </div>
            </div>
        ...
        <div class="row">
                ...
                <div class="mt-10 lg:mt-20 lg:text-center lg:max-w-xl lg:mx-auto">
                    ...
                    <div class="typewriter-">
                        <h1 class="text-3xl font-headline tracking-tight font-bold
                           ...
                           <span style="font-size: 4.5rem;"> Money Maker </span><br>Obtenez <span class="text-shadow">un peu Plus...</span><br> de <span class="text-shadow">Votre Argent!</span>                            </h1>
                    </div>
                    <br>
                    <h1 class="text-3xl font-headline tracking-tight font-bold
                        ...
                        style="min-height: 120px;">
                            <span class="txt-rotate" data-period="3000"
                                  data-rotate='[ "Recharge de carte bancaire via Mobile Money",  "Achat en ligne, paiement par QR code, et challenge de Jeux vidéo en ligne."]'>
                            </span>
                    </h1>
                    <br>
                    <table style="margin-left: -10px!important;">
                        <tr>
                            <td>
                                <a target="_blank"
                                   href="{{ URL::asset('apk/moneymaker.apk') }}">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4" data-aos="fade-left" data-aos-delay="200">
               ...
               <div style="display: flex;"> 
                    <img src="{{ URL::asset('complement/assets/img/momo.png') }}" style="transform: skew(25deg);border-radius: 0px;margin-top: 10px;" width="150">
                    <img src="{{ URL::asset('complement/assets/img/uba.png') }}" style="transform: skew(25deg);border-radius: 0px;margin-top: 10px;" width="75"></div> 
                    <img src="{{ URL::asset('complement/assets/img/eco.png') }}" style="transform: skew(25deg);border-radius: 0px;margin-top: 10px;" width="75"></div>
                </div>
            </div>
    </div>
</div>
...
<div class="lg:overflow-hidden" id="learn-more">
                    ...
                    <div class="lg:w-1/2">
                        ...
                        <div class="md:w-3/5 lg:w-full" data-aos="fade-down-right">
                            <h2 class="text-2xl lg:text-3xl font-headline tracking-tight text-gray-900
                             leading-snug">
                                ...
                                De <span class="color bold"> Mobile-Mobile </span> à votre
                                <span class="color bold"> Carte bancaire </span>                                </h2>
                            <p class="mt-3 text-lg text-gray-700">
                                Créer votre compte Money Maker. Obtenez une carte bancaire virtuelle. Recharger là via Mobile Money.
                                <u class="color">Instantanément</u> de n'importe où.                                </p>
                        </div>
                        ...
                        <div class="md:flex md:-mx-4 lg:block">
                            ...
                            <div class="md:px-4 md:w-1/2 lg:w-full lg:flex lg:mt-12" -data-aos="flip-right"
                                ...
                                <div class="mt-4 lg:mt-0 lg:ml-6">
                                    <h2 class="text-lg text-gray-900 font-medium color">
                                        Rechargez votre carte bancaire en temps réel.                                        </h2>

                                    <p class="mt-2 text-normal text-gray-700">
                                        Il n&#039;y a pas de paperasse à faire car vous n&#039;avez pas besoin d&#039;aller remplir votre carte bancaire physiquement. Il suffit de faire un dépôt depuis Money Maker,
                                        approuver la transaction Mobile Money depuis votre téléphone et c&#039;est tout !                                        </p>
                                </div>
                            </div>
                            <div class="md:px-4 md:w-1/2 lg:w-full lg:flex lg:mt-12" -data-aos="fade-up">
                                ...
                                <div class="mt-4 lg:mt-0 lg:ml-6">
                                    <h2 class="text-lg text-gray-900 font-medium color">
                                        Acheter en ligne et faites des paiements dans vos boutiques avec votre carte virtuelle                                       </h2>

                                    <p class="mt-2 text-normal text-gray-700">
                                        Votre solde est disponible en temps réel pour les transactions en ligne. Profitez de tous les avantages d&#039;une carte virtuelle instantanément rechargée.                                        </p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="bg-- bg-gradient---">
        ...
        <center>
            <h1 class="text-2xl lg:text-3xl font-headline tracking-tight text-gray-900 text-shadow
                ...
                Payez en ligne avec Money Maker, <strong>Partout</strong>
            </h1>
        </center>
        <br>
    ...
    <div class="relative px-5 pt-4 pb-20 lg:pt-48 max-w-xl md:max-w-2xl lg:max-w-5xl mx-auto"
        ...
        <div class="relative lg:w-1/2 lg:ml-auto lg:mr-0 " --data-aos="fade-left" data-aos-delay="10">
            ...
            <h3 class="text-2xl lg:text-3xl font-headline tracking-tight text-gray-900 leading-snug" style="font-size:2rem">
                ...
                <strong class="color"> Money Maker - </strong> <br>est aussi le moyen le plus simple de payer dans des boutiques avec son paiement par QR code.
                <u> sans les jetons </u>                </h3>
            ...
            <div class="md:flex md:-mx-4 lg:block">
                <div class="md:px-4 md:w-1/2 lg:w-full lg:flex lg:mt-12">
                    ...
                    <div class="mt-4 lg:mt-0 lg:ml-6">
                        <h2 class="text-lg text-gray-900 font-medium color">
                            Il suffit de scanner le QR code et de payer                            </h2>
                        <p class="mt-2 text-normal text-gray-700">
                            C&#039;est aussi simple que ça. Payez dans les boutiques ou partout où Money Maker est accepté.                            </p>
                    </div>
                </div>
                <div class="md:px-4 md:w-1/2 lg:w-full lg:flex lg:mt-12">
                    <div class="mt-10 lg:mt-0 lg:flex-shrink-0">
                    ...
                    <div class="mt-4 lg:mt-0 lg:ml-6" style="margin-bottom: 3rem;">
                        <h2 class="text-lg text-gray-900 font-medium color">
                            Retrait vers Mobile Money                            </h2>
                        <p class="mt-2 text-normal text-gray-700">
                            Retirer votre argent vers votre compte Mobile Money en temps réel.                            </p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="pt-4 lg:pt-32 pb-12 bg-gray-900 bg">
        ...
        <div class="lg:relative px-5 max-w-xl md:max-w-2xl lg:max-w-5xl mx-auto">
            <div class="hidden absolute -mt-20 bg-no-repeat lg:block lg:right-0 z-depth-2 bg2 hoverable" id="back6"  style="display: flex; align-items:center; justify-content: center; left: 40rem;">
                <img src="{{ URL::asset('complement/assets/img/logo.jpg') }}">
            </div>
            <br><br><br>
            <!-- Dark Features Section Heading -->
            <div class="md:max-w-lg">
                <h2 class="text-2xl lg:text-3xl font-headline tracking-tight text-white leading-snug text-shadow">
                    Money Maker c&#039;est avant tout - Une plateforme robuste et sécurisée qui fait du paiement numérique un jeu d&#039;enfant.                    </h2>

                <p class="mt-3 text-lg">
                    Nous travaillons intelligemment pour simplifier la façon dont vous payez. Sachez comment et où vous dépensez. Payez sans espèces, payez facilement,
                    suivez vos habitudes de dépenses pour obtenir plus de votre argent.                    </p>
            </div>
            ...
            <div class="md:flex md:-mx-4 lg:mt-16">
                <div class="md:px-4 md:w-1/3">
                    ...
                    <h2 class="mt-4 text-lg text-white font-medium bold text-shadow">
                        Confidentialité et Sécurité                        </h2>
                    <p class="mt-2">
                        Nous vous soutenons. Vos données sont cryptées, bien protégées et sécurisées.
                        Les quelques informations recueillies auprès de vous sont UNIQUEMENT destinées aux processus réglementaires.                        </p>
                </div>
                ...
                <div class="md:px-4 md:w-1/3">
                    ...
                    <p>
                        Nous croyons en la simplicité, c&#039;est pourquoi nous avons réduit toutes les étapes compliquées pour l&#039;ouverture d&#039;un compte. Commencer est aussi simple que l&#039;ABC.                        </p>
                </div>
                ...
                <div class="md:px-4 md:w-1/3">
                    ...
                    <h2 class="mt-4 text-lg text-white font-medium bold text-shadow">
                        Frais de transaction réduits                        </h2>
                    <p>
                        La transparence est la clé ! Il n&#039;y a jamais de frais cachés. Nous avons des taux de frais fixes pour les transactions réussies SEULEMENT.                        </p>
                </div>
            </div>
        ...
        <div class="md:flex md:-mx-4">
            ...
            <div class="md:px-4 md:w-1/3">
                ...
                <h2 class="mt-4 text-lg text-gray-900 font-medium">
                    Plateforme facile à utiliser                    </h2>

                <p class="mt-2 text-normal text-gray-700">
                    Une application intuitive, facile à utiliser.                    </p>
            </div>
            ...
            <div class="md:px-4 md:w-1/3">
                ...
                <h2 class="mt-4 text-lg text-gray-900 font-medium">
                    Vous avez accès à toutes vos transactions                    </h2>

                <p class="mt-2 text-gray-700">
                    Voir comment vous dépensez. Tous les détails de chaque transaction que vous avez effectuée sont mis à disposition.                    </p>
            </div>
            ...
            <div class="md:px-4 md:w-1/3">
                ...
                <h2 class="mt-4 text-lg text-gray-900 font-medium">
                    Carte virtuelle disponible                    </h2>

                <p class="mt-2 text-gray-700">
                    Vous avez accès à votre numéro de carte viruelle, à son expiration et au Card Validation Code (CVC)                    </p>
            </div>
        </div>
    </div>
    ...
    <div class="px-5 pb-16 max-w-xl md:max-w-2xl lg:max-w-5xl mx-auto">
        <div class="md:flex md:-mx-4">
            ...
            <div class="md:px-4 md:w-1/3">
                ...
                <h2 class="mt-4 text-lg text-gray-900 font-medium">
                    Gérer votre compte                    </h2>
                <p class="mt-2 text-normal text-gray-700">
                    Gardez votre compte sous contrôle. Gérez votre code PIN, votre numéro de téléphone et d&#039;autres informations sur votre compte.                    </p>
            </div>
            <div class="md:px-4 md:w-1/3">
                <div class="mt-10 md:mt-0">
                ...
                <p class="mt-2 text-gray-700">
                    Pour toutes les questions que vous vous posez, vous trouverez dans notre Foire aux questions (FAQ).                    </p>
            </div>
            ...
            <div class="md:px-4 md:w-1/3">
                ...
                <h2 class="mt-4 text-lg text-gray-900 font-medium">
                    Assistance en direct, 24 heures sur 24                    </h2>
                <p class="mt-2 text-gray-700">
                    Demandez à quelqu&#039;un de vous aider à travers notre
                    assistance en direct, ou laissez-nous un message et nous reviendrons vous aider en un rien de temps.                    </p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="sm:pb-16 max-w-xl md:max-w-2xl lg:max-w-5xl mx-auto">
        <div class="lg:max-w-xl lg:text-center lg:mx-auto px-5 pb-10
            ...
            <div class="mt-16 text-2xl lg:text-3xl font-headline tracking-tight leading-snug text-gray-900">
                ...
                Frais de transaction <span class="text-cyan-500 font-medium"> Fixes </span>
            </div>

            <div class="mt-4 text-gray-700">
                Vous êtes facturé UNIQUEMENT pour ce que vous avez dépensé avec succès.                </div>
        </div>
        ...
        <div class="lg:relative sm:px-5 lg:flex lg:-mx-4">
                ...
                <div
                    ...
                    <div class="px-5 pt-8 sm:pt-6">
                        <div class="text-lg text-gray-900 font-medium">
                            Dépôt via Mobile Money                            </div>
                        <div class="mt-2 text-gray-700">
                            Le dépôt Mobile Money est automatique et instantané. !                            </div>
                    </div>
                    <div class="">
                        <div class="px-5 pb-8">
                            <div class="mt-6 px-4 py-4 bg-gray-100 rounded-lg">
                                <div class="flex items-center">
                                    ...
                                    <span> <span class="ml-3 font-medium">Dépôts</span>   réussis </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="px-5 pt-5 pb-5 border-t-2 border-gray-100">
                            <div class="flex justify-between items-center">
                                    <span class="font-headline tracking-tight text-5xl">0.3%
                                        <span style="font-size: 50%!important;"> </span>
                                    </span>

                                <!--                                         <a href="/register" class="inline-flex items-center pl-4 pr-1 py-1 leading-none rounded bg-cyan-500 text-white font-medium">
                                        Get Started

                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="ml-1 h-8 w-8 fill-current mt-px opacity-50">
                ...
                <div class="flex flex-col lg:justify-between lg:flex-1 bg-cyan-900 sm:rounded-lg sm:mt-6 lg:mt-0">
                    <div class="px-5 pt-8 sm:pt-6">
                        ...
                        <div class="mt-2 text-gray-300">
                            Nous appliquons un taux fixe de  0.3% pour chaque retrait vers Mobile Money.                            </div>
                    </div>
                        ...
                        <div class="px-5 pb-8">
                            <div class="mt-6 px-4 py-4 bg-gray-300-05 rounded-lg">
                                <div class="flex items-center text-gray-300">
                                    <span><span class="ml-3 text-cyan-500 font-medium"> Mobile Money </span> Retrait </span>                                    </div>

                                <!--<div class="mt-3">
                                        <div class="flex items-center text-gray-300">
                                            icon_here
                                            <span><span class="ml-3 text-cyan-500 font-medium">Unlimited</span> deployments</span>
                                        </div>
                                    </div> -->
                            </div>
                        </div>
            ...
            <div class="lg:w-1/2 lg:px-4 lg:flex lg:flex-col" -data-aos="fade-right">
                <div
                    ...
                    <div class="px-5 pt-8 sm:pt-6">
                        <div class="text-lg text-gray-900 font-medium">
                            Payer par Money Maker
                        </div>
                        <div class="mt-2">


                            Pour des paiements faciles, pratiques et rapides dans les magasins locaux.
                        </div>
                    </div>
                    <div class="">
                        <div class="px-5 pb-8">
                        ...
                        <div class="px-5 pt-5 pb-5 border-t-2 border-gray-100">
                            <div class="flex justify-between items-center">
                                <span class="font-headline tracking-tight text-5xl">Gratuit</span>
                            </div>

                            <div class="text-gray-500 text-sm">


                                Les frais sont susceptibles d'être modifiés à l'avenir
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="px-5 max-w-xl mx-auto">
        <div class="text-2xl lg:text-3xl font-headline tracking-tight text-center leading-snug text-gray-900">
            ...
            <p class="mt-2 font-semibold">
                Créer votre compte et faites-en l&#039;expérience vous-même                </p>
        </div>
    ...
    <div class="relative flex px-5 max-w-xl md:max-w-2xl lg:max-w-5xl mx-auto">
        ...
        <div class="w-1/2 lg:w-1/4 px-2">
            ...
            <ul class="mt-4 text-gray-700">
                ...
                <li class="mt-1"><a href="https://fb.com/Money Makerhq"> Contactez-nous </a></li>
            </ul>
        </div>
        ...
        <div class="w-1/2 lg:w-1/4 px-2">
            ...
            <ul class="mt-4 text-gray-700">
                <li><a href="https://fb.com/Money Makerhq">Assistance Directe</a></li>
...
<div class="pt-6 pb-6 bg-gray-100 text-gray-500">
    <div class="flex items-center justify-between px-5 max-w-xl md:max-w-2xl lg:max-w-5xl mx-auto">
        <div>
            © Money Maker - 2021 by <a href="https://www.perfitcom.com" style="color: #efaa1e">PERFITCOM</a>
        </div>

        <div>
            <a target="_blank" href="https://www.facebook.com/moneymakercmr" class="">
                <i class="socicon-facebook color text-shadow"></i>
            </a>
            &nbsp;&nbsp;&nbsp;
            <a target="_blank" href="https://www.linkedin.com/company/money-maker-cameroon/" class="">
                <i class="socicon-linkedin color text-shadow"></i>
            </a>
            &nbsp;&nbsp;&nbsp;
            <a target="_blank" href="https://www.youtube.com/channel/UC2gSlW4iSxIkLsNe7j-fGIA" class="">
                <i class="socicon-youtube color text-shadow"></i>
            </a>
            &nbsp;&nbsp;&nbsp;
            <a target="_blank" href="https://twitter.com/237moneymaker">
            ...
            &nbsp;&nbsp;&nbsp;
            <a target="_blank" href="https://www.instagram.com/moneymakerkamer/">
