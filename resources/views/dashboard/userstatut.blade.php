                    ...
                    <div class="collapse" id="listthree">
                        <div class="list-box">
                            ...
                            @endif
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Nouveau scan Passeport/ Cni(CNI Recto)</label> 
                                        <div class="custom-file">
                                            <input type="file" class="" name="nv_scan_piece_recto" id="nv_scan_piece_recto" accept="image/png, image/jpeg, image/jpg">
                                        </div>
                                    </div>                                        
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Nouveau scan Passeport/ Cni(CNI Verso)</label> 
                                        <div class="custom-file">
                                            <input type="file" class="" name="nv_scan_piece_verso" id="nv_scan_piece_verso" accept="image/png, image/jpeg, image/jpg">
                                        </div>
                                    </div>                                        
                                </div>
                            </div>
