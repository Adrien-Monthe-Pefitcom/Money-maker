...
<link rel="stylesheet" type="text/css" href="{{ URL::asset('bower_components/pnotify/dist/pnotify.css')}}">
 ...
 <div id="appCapsule">
   <div class="section mt-2 text-center">
     ...
     <h4 style="color: #efaa1e;">Le commercial doit obligatoirement poser sa signature et accepter les conditions d'utilisations pour la soumission du formulaire</h4>
   </div>
           ...
           <div class="row d-flex justify-content-center">
               <div class="col-md-8">
                   <div class="wizard">
                       ...
                       <form role="form" action="{{route('process-register-comm')}}" method="POST" id="msform" enctype="multipart/form-data" class="login-box">
                        @csrf
                                   ...
                                   <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" class="" name="scan_casier" id="scan_casier" style="width:359px" accept="application/msword, application/pdf, .docx, image/png, image/jpeg, image/jpg">
                                                    <br />
                                   ...
                                   <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input class="form-control" type="hidden" name="num_compte_comm" id="numcompte_comm" placeholder="">
    ...
    if(errors.length == 0) {
     ...
     $("#next3").click(function (e) {
        ...
        .each(function() {
            ...
            if (error_scan_cv == true){
                errors3.push("erreur"); 
            }        
            
            if (error_scan_casier == true){
                errors3.push("erreur"); 
            }
...
// num compte commercial
let numcomm = Math.floor(Math.random() *(90100000100 - 10100000100) + 90100000100);
