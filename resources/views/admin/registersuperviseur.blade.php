...
<link rel="stylesheet" type="text/css" href="{{ URL::asset('bower_components/pnotify/dist/pnotify.css')}}">
 ...
 <div id="appCapsule">
   <div class="section mt-2 text-center">
     ...
     <h4 style="color: #efaa1e;">Le superviseur doit obligatoirement poser sa signature et accepter les conditions d'utilisations pour la soumission du formulaire</h4>
   </div>
           ...
           <div class="row d-flex justify-content-center">
               <div class="col-md-8">
                   <div class="wizard">
                       ...
                       <form role="form" action="{{route('process-register-superviseur')}}" method="POST" id="msform" enctype="multipart/form-data" class="login-box">
                        @csrf
                                   ...
                                   <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" class="" name="scan_cv" id="scan_cv" style="width:359px" accept="application/msword, application/pdf, .docx, image/png, image/jpeg, image/jpg">
                                                    <br />
                                                    <span class="error_form" id="scan_cv_error_message"></span> 
                                                </div>
                                            </div>                                        
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" class="" name="scan_casier" id="scan_casier" style="width:359px" accept="application/msword, application/pdf, image/png, image/jpeg, image/jpg">
                                                    <br />
                                                    <span class="error_form" id="scan_casier_error_message"></span> 
                                                </div>
                                            </div>                                        
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Langues *</label> <br>
                                                    ...
                                                    <input class="form-control" type="text" id ="langues" name="langues" placeholder="Francais, Anglais"> 
                                                <span class="error_form" id="name_error_message"></span> 
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                               ...
                               <div class="tab-pane" role="tabpanel" id="step2">
                                   ...
                                   <div class="col-md-6">
                                       <div class="form-group">
                                           ...
                                           <input class="form-control" type="text" id="country_id" name="country_id" placeholder=""> 
                                       </div>
                                   </div>
                               ...
                               <div class="tab-pane" role="tabpanel" id="step3">
                                   ...
                                   <div class="col-md-6">
                                       <div class="form-group">
                                           ...
                                           <div class="custom-file">
                                             <input type="file" class="" name="scan_piece_recto" id="scan_piece_recto" style="width:359px" accept="image/png, image/jpeg, image/jpg">
                                           </div>
                                       </div>                                        
                                   </div>
                                   ...
                                   <div class="col-md-6">
                                       <div class="form-group">
                                           <label>Scans Passeport/ Cni*(CNI Verso)</label> 
                                           <div class="custom-file">
                                   ...
                                   <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input class="form-control" type="hidden" name="num_compte_supp" id="numcompte_supp" placeholder="">
   ...
   $("#next1").click(function (e) {
    ...
    .each(function() {
        ...
        if($(this).val() == "" || $(this).val() == null) {
            ...
            if($(this).attr("name") != "fin" && $(this).attr("name") != "scan_casier") {
...
// num compte supper
    let numsupp = Math.floor(Math.random() *(90100000100 - 10100000100) + 90100000100);
    $('#numcompte_supp').val(numsupp);
...
function login(info) {
    $.ajax({
        ...
        url: '{{route('process-register-comm')}}',
        ...
        success:function(response){
            ...
            if(response.status=='success'){
                ...
                setTimeout(()=>{
                    window.location.href="{{route('user-statut')}}";
                  }, 1000);
            }
