...
<link rel="stylesheet" type="text/css" href="{{ URL::asset('bower_components/pnotify/dist/pnotify.css')}}">
 ...
 <div id="appCapsule">
   <div class="section mt-2 text-center">
     ...
     <h4 style="color: #efaa1e;">NB: Veuillez valider votre signature et accepter les conditions d'utilisation pour la soumission du formulaire</h4>
   </div>
           ...
           <div class="row d-flex justify-content-center">
               <div class="col-md-8">
                   <div class="wizard">
                       ...
                       <form role="form" action="{{route('process-register-client')}}" method="POST" id="msform" enctype="multipart/form-data" class="login-box">
                        @csrf
