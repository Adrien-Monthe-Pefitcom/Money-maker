    ...
    <form role="form" action="{{route('validuser')}}" class="login-box" method="GET">
...
<br />
                                    ...
                                    <li><a href="/validate" class="btn" style="background: #424145; color: white ">Annuler Operation</a></li>
