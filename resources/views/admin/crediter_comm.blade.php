...
<main>
    ...
    <div class="container-fluid">
        <h1 class="mt-4">Premier Depot </h1>
    <!-- App Capsule -->
    <div id="appCapsule">
        <div class="tab-pane" role="tabpanel" id="Part1">
            ...
            <div class="all-info-container">
                        ...
                        <!-- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ -->
                        <form role="form" action="/crediter_compte_commercial" class="login-box">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="number" min="5000" max="1000000" name="amount_trans"  placeholder="0.00" id="map">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
...
//-----------------------------------------------------------------------------------------
                    ...
                    xhttp.onreadystatechange = function() {
                        ...
                        document.getElementById("output_1").innerHTML = this.responseText;
                        }
                    };
                    xhttp.open("GET", "getretrievalfee.php?q="+str, true);
                    xhttp.send();
