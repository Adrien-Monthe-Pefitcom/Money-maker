           ...
           <div class="row d-flex justify-content-center">
               <div class="col-md-8">
                   <div class="wizard">
                       ...
                       <form role="form" action="{{route('process-register-comm-by-sup')}}" method="POST" id="msform" enctype="multipart/form-data" class="login-box">
                        @csrf
                                   ...
                                   <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" class="" name="scan_cv" id="scan_cv" style="width:359px" accept="application/pdf, application/msword, image/png, image/jpeg, image/jpg">
                                                    <br />
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" class="" name="scan_casier" id="scan_casier" style="width:359px" accept="application/pdf,application/msword,  image/png, image/jpeg, image/jpg">
                                                    <br />
