...
<div id="appCapsule">
    ...
    <div class="section mt-2 text-center">
        ...
        <h4>Fill in all the required Information</h4>

        <h4 style="color: #efaa1e;">Please validate with your signature before the submission of the form</h4>
            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-md-8">
                    ...
                    <div class="wizard">
                        ...
                        <form role="form" action="{{route('process-user-register')}}" method="POST" id="msform" enctype="multipart/form-data" class="login-box">
                            ...
                            <div class="tab-content" id="main_form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label>Password *(8 Characters) <i class="far fa-eye" id="togglePassword" onclick="togglePasswordFieldClicked()"></i> </label>
                                                ...
                                                <label>(8 Characters) Atleast One capital Letter, A Number, And a Special Character</label>
                                ...
                                <div class="tab-pane" role="tabpanel" id="step2">
                                    ...
                                    <h4 class="text-center">Supplementary Informations 1</h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label>CEMAC Unique Identifier</label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="type_compte" class="type_compte form-control" id="type_compte">
                                                    ...
                                                    <option value="Compte Marchand">Merchand Account</option>
                                ...
                                <div class="tab-pane" role="tabpanel" id="step3">
                                    ...
                                    <h4 class="text-center"> Supplementary Informations 2</h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label>Bank Name (Not Mandatory)</label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label>Bank Account Number (Not Mandatory)</label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label>Identification Number (Passport/NIC)*</label>

                                                <input class="form-control" type="text" name="num_piece" id="num_piece" placeholder="" minlength="4">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label>Identification Document * (Front View)</label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label>Identification Document * (Rear View)</label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="parrain" id="referee_get" disabled="true" placeholder="" value="{{$_GET['refere_par']}}" minlength="5">

                                                @else

                                                <label>Referee</label>

                                                <input class="form-control" type="text" name="parrain" id="referee" placeholder="" minlength="5">
                                ...
                                <div class="tab-pane" role="tabpanel" id="step4">
                                    ...
                                    <h4 class="text-center">Verify the Information you entered</h4>

                                    <div class="all-info-container">

                                        <div class="list-content">

                                            <a href="#listone" data-toggle="collapse" aria-expanded="false" aria-controls="listone">Your Basic Informations <i class="fa fa-chevron-down"></i></a>
                                        ...
                                        <div class="list-content">
                                            ...
                                            <a href="#listtwo" data-toggle="collapse" aria-expanded="false" aria-controls="listtwo">Supplementary Informations 1 <i class="fa fa-chevron-down"></i></a>
                                        ...
                                        <div class="list-content">
                                            ...
                                            <a href="#listthree" data-toggle="collapse" aria-expanded="false" aria-controls="listthree">Supplementary Information 2 <i class="fa fa-chevron-down"></i></a>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" type="text" name="referee2" id="referee2" placeholder="" disabled="true">
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content" style="position: fixed;">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="button" id="sig-submitBtn" name ="valider" style="background: #efaa1e; color: white;" value="validate the Signature" class="btn" style="background: #747c7c; color: white ">

                                                    <input type="button" id="sig-clearBtn" name ="cancel" id="sig-clearBtn" value="Cancel Signature" class="btn" style="background: #747c7c; color: white "><br><br>
                                    ...
                                    <input type="checkbox" name="accepted" id="conditions" value="accepted">I have <strong>read and I accept</strong>  <a href="/tos" target="_blank">The Terms and Conditions</a> Linked to the utiisation of Money Maker
                                    ...
                                    <ul class="list-inline pull-right">
                                        ...
                                        <li><input type="reset" id="cancel2" name ="cancel_save" value="Cancel Register" class="btn" style="background: #424145; color: white "></li>

                                        <li><input type="submit" value="Register Me" id="btn-submit" name="regist" class="btn" style="background: #efaa1e; color: white;"></li>
            ...
            $("#next2").on('click', function() {
                ...
                if (errors2.length > 0) {
                    ...
                    new PNotify({
                        ...
                        text: 'Erreur. Veuillez fournir votre identifiant unique(Zone Cemac)',
