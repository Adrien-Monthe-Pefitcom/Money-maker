...
<div class="appHeader text-light" style="background:  #f2f2fc; box-shadow: 0 19px 38px rgba(0,0,0,0.30), 0 15px 12px rgba(0,0,0,0.22); height: 10vh;">
    <div class="left">
    <a href="/"><img src="{{ URL::asset('complement/assets/img/logo.png') }}" width="120rem"></a>
                    <a style="color:black" class="headerButton" data-toggle="modal" data-target="#sidebarPanel">
...
<!-- * App Header -->
     ...
     <div>  
        <div>
            ...
            <div style="background: url(assets/images/pretttybg.jpg); background-size: cover;" class="page-holder bg-cover center">
                ...
                <header class="text-center text-white py-5" style="position: absolute; text-align: center; padding: 2rem;">
                        ...
                        <h1 class="display-6 font-weight-bold mb-4" style="color:  white;">L'appli pour toutes vos transactions financières</h1>
