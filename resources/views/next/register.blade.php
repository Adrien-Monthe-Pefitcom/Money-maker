                                   ...
                                   <div class="row">
                                       ...
                                       <div class="col-md-6">
                                           ...
                                           <div class="form-group">
                                               ...
                                               <label>Mot de passe * <i class="far fa-eye" id="togglePassword" onclick="togglePasswordFieldClicked()"></i> </label>
                                               <input class="form-control" type="password" id="password"  minlength="8" name="password" placeholder="Exemple: Qweasd_1">

                                               <span class="error_form" id="password_error_message"></span>
                                               <label>Au moins 8 caract�res, Une lettre majuscule, un chiffre, un caractere special et des minuscules</label>
                                           </div>
                                       </div>
