   @extends('layouts.layout2')
    ...
    <section class="page-section" id="services">
            <div class="container">
                <h1 class="text-center mt-0">Bienvenue Sur Money Maker!</h1>

                <div class="row">
                    <div class="col-lg-3 col-md-6 text-center add">
                        <div class="mt-5" data-toggle="modal" data-target="#vertically-centered">
                            <img src="{{ URL::asset('complement/assets/img/sms.png') }}" width="70rem;" style="margin-bottom: 2rem;">
                            <h4 class="h4 mb-2">Verifier votre Numéro de téléphone</h4>
                            <p class="text-muted mb-0">Nous vous avons envoyer un code par SMS, remplissez le ici</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center add">
                        <div class="mt-5">
                            <img src="{{ URL::asset('complement/assets/img/email.png') }}" width="70rem;" style="margin-bottom: 2rem;">
                            <h4 class="h4 mb-2">Verifier votre Email</h4>
                            <p class="text-muted mb-0">Nous vous avons envoyer un code à votre adresse, remplissez le ici</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center add">
                        <a href="/userinfo"><div class="mt-5">
                            <img src="{{ URL::asset('complement/assets/img/account.png') }}" width="70rem;" style="margin-bottom: 2rem;">
                            <h4 class="h4 mb-2">Verifier vos infromations</h4>
                            <p class="text-muted mb-0">Relisez et modifier vos information</p>
                        </div></a>
                    </div>
                </div>
                <div class="row center2">
                  <a class="center2 btn" style="width: 50rem; color: white; background: #4b4c4a; margin:auto; " href="/dashboard">Acceder à mon Compte</a>
                </div>
            </div>

        <div class="modal fade" id="vertically-centered" title="Vertically centered" :centered="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title"><b>Entrez Le Code qui vous a été envoyé</b></h4>
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary btn-flat" name="login">Login</button>
                        </form>
                    </div>
                </div>
            </div>
